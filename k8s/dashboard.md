...
```shell
kubectl applay -f /vagrant/config/dashboard.yml
```
...
```shell
[vagrant@k8s-master]$ kubectl get svc -n kubernetes-dashboard
NAME                        TYPE        CLUSTER-IP      EXTERNAL-IP   PORT(S)         AGE
dashboard-metrics-scraper   ClusterIP   10.107.69.74    <none>        8000/TCP        60m
kubernetes-dashboard        NodePort    10.105.36.254   <none>        443:30000/TCP   60m
```
